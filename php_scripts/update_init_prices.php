...
<?php
  ...
  for ($i = 0; $i < $arraylen; $i++){
    ...
    $start_price1 = number_format($prices1[3], 2);
    $start_price2 = number_format($prices2[3], 2);
   
    $update_sql = "update trader_game set start_price=\"$start_price1;$start_price2\" where round = $max_round and target_stock = \"$stock_codes[$i]\"";
    echo $update_sql . "\n";
