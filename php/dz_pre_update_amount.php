...
if ($validateResult != "VALID") {
	...
	$update_sql = "update stock_dz_pre_track set dz_amount=$dz_amount where stockcode = '$stockcode' and dz_firm_approved_date = $dz_firm_approved_date";
