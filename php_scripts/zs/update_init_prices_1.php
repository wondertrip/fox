...
<?php
  ...
  $all_stocks = mysql_query("select * from zs_game where round = $max_round and num = 54");
  ...
  for ($i = 0; $i < $arraylen; $i++){
    ...
    $start_price1 = number_format($prices1[2], 2);
    $start_price2 = number_format($prices2[2], 2);
